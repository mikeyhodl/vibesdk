...
## [1.5.0](https://github.com/mikeyhodl/vibesdk/compare/v1.4.0...v1.5.0) (2026-01-12)


### Features

* add abort signal support to inference operations ([f3e545e](https://github.com/mikeyhodl/vibesdk/commit/f3e545e742b7b4cedb4c74b3af9501327ee8a8b3))
...
* add ai-based project type detection and workflow support ([2aea3c7](https://github.com/mikeyhodl/vibesdk/commit/2aea3c7ab3ddad9e20847567bc67960b155f7cef))
...
* add automated PR description generation workflow ([3c81d5d](https://github.com/mikeyhodl/vibesdk/commit/3c81d5d486a244ca9dfcf40495641dedea3d453a))
* add automated PR workflows and commit validation ([5ba22fc](https://github.com/mikeyhodl/vibesdk/commit/5ba22fce6f707c9b05f39bdeee291f7464d8b0bb))
...
* add bootstrap script and template customization ([1fa893f](https://github.com/mikeyhodl/vibesdk/commit/1fa893fe72f709587c7a6080d37076015dacd7c2))
...
* add completion detection and dependency-aware tool execution ([be72055](https://github.com/mikeyhodl/vibesdk/commit/be720550bdf97f85635bd3bdeceb4fecd31341d3))
...
* add completion detection and loop prevention to agentic builder and debugger ([219d2c7](https://github.com/mikeyhodl/vibesdk/commit/219d2c7c464544ebe5477ab36192be2d15ae3bbe))
...
* add conversation reset functionality with confirmation dialog ([5ebb714](https://github.com/mikeyhodl/vibesdk/commit/5ebb714087367724785f97991c9c5fbe9587e83a))
...
* add deep debug session management with state persistence and wait tools ([e60694f](https://github.com/mikeyhodl/vibesdk/commit/e60694f6334b2c05acd1c7147650fc88c9adbd61))
* add deep debugger transcript UI with collapsible tool results ([95ed92f](https://github.com/mikeyhodl/vibesdk/commit/95ed92f0111bab5f78318a810c9c965afc38a388))
* add diff toggle option to git show command ([2657ba9](https://github.com/mikeyhodl/vibesdk/commit/2657ba9706a65cd0c6bb7e7dfeaf23265c24e035))
* add duration filter option for log retrieval in sandbox ([4579da2](https://github.com/mikeyhodl/vibesdk/commit/4579da2530a45d91294fd108d9937254d93e68de))
...
* add force refresh mechanism for preview deployments ([796e34d](https://github.com/mikeyhodl/vibesdk/commit/796e34d3459657502599bdbfdeddc1144289c0e3))
* add generate_files tool for creating new files and full rewrites ([52d917f](https://github.com/mikeyhodl/vibesdk/commit/52d917f2f6ff39f2ea047f494cf579e28dab9a31))
* add Git clone functionality for repositories ([d7532f2](https://github.com/mikeyhodl/vibesdk/commit/d7532f225d6ff6fb4e9439ea02619338ac5e5207))
* add git clone protocol support with template rebasing ([6005c4d](https://github.com/mikeyhodl/vibesdk/commit/6005c4dea9fe15ee03f8a77edbba950081dd176e))
* add git version control tools and enhance debugging system ([f6b6b00](https://github.com/mikeyhodl/vibesdk/commit/f6b6b0076d0ef57ef120a0a15b6493ecb616f020))
* add GitHub Actions for issue triage + improved code-review ([d42f805](https://github.com/mikeyhodl/vibesdk/commit/d42f8050b3b3a53a4f2e5e612e156aea534cb71d))
...
* add in-memory caching for git clone operations with 5s TTL ([263ac37](https://github.com/mikeyhodl/vibesdk/commit/263ac37b3d0289f5b0ca3c1eda8273a001088321))
* add incremental GitHub sync with commit history preservation ([4785472](https://github.com/mikeyhodl/vibesdk/commit/4785472f0664b946714ef180727bc6427cbc8843))
* add inference cancellation support with AbortController ([6e752c2](https://github.com/mikeyhodl/vibesdk/commit/6e752c214197ec755c988ee0308721d1f04b50fb))
...
* add llm.md and update claude.md using it ([a1e90dd](https://github.com/mikeyhodl/vibesdk/commit/a1e90ddfe398714ca9f4af75e57ea935b184060b))
* add log file extractor tool and nanoid dependency ([0b12d76](https://github.com/mikeyhodl/vibesdk/commit/0b12d76b7fbea3d7ea9e7863e9bb6be0d0cde27f))
...
* add persistent command execution in sandbox environment ([7d02a43](https://github.com/mikeyhodl/vibesdk/commit/7d02a43669414185bed002ddc3baff463e15753d))
...
* add previous debug session context and improve error handling in debugging tools ([45ac910](https://github.com/mikeyhodl/vibesdk/commit/45ac9105ad920e36cd7b284a050a414c1913a2a6))
...
* add project mode selector with agentic behavior support ([f5a3be6](https://github.com/mikeyhodl/vibesdk/commit/f5a3be60bfdb2f19861611fa88f2f32207f75859))
* add project name generation and config file updates ([a948e62](https://github.com/mikeyhodl/vibesdk/commit/a948e62b29999f3dca31b0262438fa3608c9df35))
...
* add read-only mode for agent initialization ([7f83e19](https://github.com/mikeyhodl/vibesdk/commit/7f83e1975f72a7e1df90a6b661a45f553a882176))
...
* add stop generation button and handle cancelled state in phase timeline ([3cd7cab](https://github.com/mikeyhodl/vibesdk/commit/3cd7cabed64f8cbd012f12f63b5be6355b9a51e4))
* add streaming support to deep debugger and enhance logs tool with truncation ([1bdb1e7](https://github.com/mikeyhodl/vibesdk/commit/1bdb1e7e97c6a18ae3c3a2c69b8c14e6fdd65a19))
* add timeout handling and force redeploy option ([d2543d5](https://github.com/mikeyhodl/vibesdk/commit/d2543d5e575c45b141bb8728eeb10e3674fceb13))
* add tool result field to websocket messages and update event handling ([41fab81](https://github.com/mikeyhodl/vibesdk/commit/41fab814b6991895da1cd9eccb2acac00a6f79a4))
* add uploads routes + fix filename in r2 ([6a41be1](https://github.com/mikeyhodl/vibesdk/commit/6a41be1d0d19317146c07ac2bbaab90d46bed0df))
* add user secrets management with durable objects ([12d2132](https://github.com/mikeyhodl/vibesdk/commit/12d2132942aba41ac9afb312c901c636d9febf27))
* add wait_for_generation tool and enhance tool call result handling ([92f4e0e](https://github.com/mikeyhodl/vibesdk/commit/92f4e0e5192efd8ca0154e7d28ba6fd1f046a8da))
* add WebSocket support for sandbox proxy ([9d9d60b](https://github.com/mikeyhodl/vibesdk/commit/9d9d60b3313eee2f58e2e50fe19fdfd44ab99511))
* add WebSocket support for sandbox proxy ([72538be](https://github.com/mikeyhodl/vibesdk/commit/72538be52c99345a3fa20ec36e91a0eb274ce718))
* added user secrets store tests ([b26bbb6](https://github.com/mikeyhodl/vibesdk/commit/b26bbb6f7eb70af98b073220219db84179c46086))
...
* alter template schema to return map instead of list of files ([fad85df](https://github.com/mikeyhodl/vibesdk/commit/fad85df3b1385426fb3892d74fb97f9f4dd2d52d))
* always upload images to r2, best-try on CF Images ([5797f13](https://github.com/mikeyhodl/vibesdk/commit/5797f135679ba5c6ea0e14a73b79eee9b6567d56))
...
* code deep debugger prompt tweaks ([394a720](https://github.com/mikeyhodl/vibesdk/commit/394a720fadb9db067f343b42e344c65d471da67d))
...
* display completion message when entering finalization phase ([1365eeb](https://github.com/mikeyhodl/vibesdk/commit/1365eebae9fc150a91d048bae2e6b5cf11cda350))
* DO based git, fs storage, commit every saved file ([2156e89](https://github.com/mikeyhodl/vibesdk/commit/2156e89a22280fc7d16483e9d50ec635f0bfb2a0))
...
* enhance bootstrap command validation and safety ([ed1c006](https://github.com/mikeyhodl/vibesdk/commit/ed1c00642d452632d2aebdbc22d1c855f7bd7692))
* enhance changelog generation with detailed PR and commit data ([8950852](https://github.com/mikeyhodl/vibesdk/commit/89508523afada3f9522cdc19b994006b4e878a15))
* enhance changelog generation with detailed PR and commit data ([7850fc6](https://github.com/mikeyhodl/vibesdk/commit/7850fc620cf56372ab364711b1479a65279e5e32))
* enhance changelog generation with detailed PR and commit data ([01afb74](https://github.com/mikeyhodl/vibesdk/commit/01afb7410b3cd5e0a5bb228d9aad238e9b1d3985))
...
* enhance debugging tools with user interaction handling and runtime error detection ([b144e2c](https://github.com/mikeyhodl/vibesdk/commit/b144e2c8b63bdf803f28b0ad85f8183ae6281316))
* enhance deep debug session management and UI ([2188c90](https://github.com/mikeyhodl/vibesdk/commit/2188c90b1fecc5571ec011696f6d3f4b1e5fbd4f))
* enhance git integration with safer command access ([3c9696f](https://github.com/mikeyhodl/vibesdk/commit/3c9696f96faa27e89e025c0bd7d13c230e73ff13))
* enhance git show command with diff support and optimize message handling ([fd70b1c](https://github.com/mikeyhodl/vibesdk/commit/fd70b1c7673c3b7d84f3056167e95625098c10da))
* enhance phase timeline with debugging status and issue tracking ([79fb107](https://github.com/mikeyhodl/vibesdk/commit/79fb1071524cd654750f978332f6acc0d1ac4c2a))
* enhance PR description workflow with review capabilities ([433c398](https://github.com/mikeyhodl/vibesdk/commit/433c398b4ab9e7afb55d2c602a62c1a00ea0d896))
* enhance PR review automation with issue linking and feedback ([04720aa](https://github.com/mikeyhodl/vibesdk/commit/04720aa280c36725479941212d69c4b6305bbc17))
* enhance PR review workflow with unified analysis ([b321376](https://github.com/mikeyhodl/vibesdk/commit/b3213764e02fcebd19858d2036bc3db245ed0bde))
...
* enhance security of secrets management system ([078fbee](https://github.com/mikeyhodl/vibesdk/commit/078fbeeb75fdda209036441a4649eb28d074a1ca))
* enhance template file filtering with pattern matching and add nanoid generator ([68678ac](https://github.com/mikeyhodl/vibesdk/commit/68678ac3a06b71d936a8b5f8e9e146b093d6d9a0))
...
* extend PR review trigger to include synchronize events ([16e18ba](https://github.com/mikeyhodl/vibesdk/commit/16e18ba8e3514377e75011bd36e1861a6839829d))
...
* finish most refactor and get it to build ([5685c7d](https://github.com/mikeyhodl/vibesdk/commit/5685c7d6aa3de016954e09beea6ede46cb1911fd))
* fix frontend types + proper load convo state ([3d6cc16](https://github.com/mikeyhodl/vibesdk/commit/3d6cc16432e96a6b7a5b2e2bbc8084bb5fe419c0))
...
* general agent ([5e4ebb2](https://github.com/mikeyhodl/vibesdk/commit/5e4ebb2e86f7094978499de6796bf3891b19a6ef))
* git repos finally working ([d2e4594](https://github.com/mikeyhodl/vibesdk/commit/d2e4594771869cbc0f3c8140445bb39ac677ddbb))
* implement collapsible tool result viewer with JSON formatting support ([9ae4640](https://github.com/mikeyhodl/vibesdk/commit/9ae464050cad6a55aa10f87df01f0739ccc00364))
* implement message deduplication to prevent duplicate assistant responses ([0256634](https://github.com/mikeyhodl/vibesdk/commit/0256634a6a042d7136a6b9bcda80ea92a8d1478c))
...
* implement project name and blueprint update tools ([871548f](https://github.com/mikeyhodl/vibesdk/commit/871548febfdcf6efd5d3fade563f8a7738f64e08))
...
* improve AI Gateway token validation and handling ([f0bce24](https://github.com/mikeyhodl/vibesdk/commit/f0bce241777d772a9542ad4336da41d9eded6664))
* improve chat message handling and reconnection flow ([b7e1ae2](https://github.com/mikeyhodl/vibesdk/commit/b7e1ae27b1c1c837abf919be1ad53b899e3420ba))
* improve chat message handling and reconnection flow ([d853266](https://github.com/mikeyhodl/vibesdk/commit/d8532668ec9ff595522c9fe9169b20a74c55baa7))
* improve code regen ([c3baadf](https://github.com/mikeyhodl/vibesdk/commit/c3baadff98b875a8ba8d434cedeba464ab79daa3))
* improve error handling and message display for debugging ([472688d](https://github.com/mikeyhodl/vibesdk/commit/472688dd38f406bad1e6784901ec7124910a11c5))
...
* improve GitHub Actions workflow reliability ([740bf1c](https://github.com/mikeyhodl/vibesdk/commit/740bf1c383f5221ab141fa9b93a6183b65906b2f))
* improve package.json synchronization with sandbox ([a960bc2](https://github.com/mikeyhodl/vibesdk/commit/a960bc2836bfa05da3ee465df7d4d4955f581661))
...
* improve sandbox and git integration ([8044881](https://github.com/mikeyhodl/vibesdk/commit/8044881621661f681a045b6f5af65826c2fd09c1))
* improve sandbox directory handling and error recovery ([eaf5bd5](https://github.com/mikeyhodl/vibesdk/commit/eaf5bd57b78e5a9f2a102f08c2f72ea95e66955e))
...
* improve tab layout and git clone button placement ([8b6f908](https://github.com/mikeyhodl/vibesdk/commit/8b6f9086cf7e319fe7e0e7e758baa371bfd63490))
* improve tab layout and git clone button placement ([c1b8a02](https://github.com/mikeyhodl/vibesdk/commit/c1b8a02c7188789036f1a964a9f80787394d80ee))
* improve template selection reliability and prompt clarity ([8ed1a08](https://github.com/mikeyhodl/vibesdk/commit/8ed1a0840b70f3e48a6245a89d4b4d468093ee97))
* improve tool calling depth handling for debugging ([73af22b](https://github.com/mikeyhodl/vibesdk/commit/73af22b1a43fdb0ed1ebbfbe06df3288b38e25ea))
...
* in memory get template details ([e01f067](https://github.com/mikeyhodl/vibesdk/commit/e01f067969e1ad414257a312d7c887216c06fe46))
* increase instance resources and improve GitHub file export handling ([bfa4855](https://github.com/mikeyhodl/vibesdk/commit/bfa48552cb8e03123dc341ac79cfab5d307e1120))
...
* initial implementation of deep debugging agent ([520c2f6](https://github.com/mikeyhodl/vibesdk/commit/520c2f61fc5d6a012c45a5cb487fc728e2be3fb4))
...
* isolated deepdebug window ([6605ecd](https://github.com/mikeyhodl/vibesdk/commit/6605ecdf51aa6f2c7feacc91ad2f3b1cdfb91127))
* latest packages updated ([e5496e0](https://github.com/mikeyhodl/vibesdk/commit/e5496e0cfd2923acc25d7e4f2265b4a0d7fd69f8))
* limit deep_debug tool to one call per conversation turn ([1b13c71](https://github.com/mikeyhodl/vibesdk/commit/1b13c71b719871fc5c60e1a5e45a08bc90db2456))
* make deterministic code fixer completely sync ([23f0261](https://github.com/mikeyhodl/vibesdk/commit/23f0261d9079c9c2991074180c8b5468af0e085a))
* more prompt tweaks for react/frontend ([866c881](https://github.com/mikeyhodl/vibesdk/commit/866c881612adcbf1f658d63d20caeddee42c6602))
...
* optimize GitHub push with per-commit trees and blob deduplication ([c73b698](https://github.com/mikeyhodl/vibesdk/commit/c73b698057e7648c4b318f0dc83908797096756e))
...
* presentation specific prompts + prompts restructuring ([0bfcdbb](https://github.com/mikeyhodl/vibesdk/commit/0bfcdbbb52c7707e32b8a0eaf8cc411f107206e5))
* prompt refinements for zustand ([ff604c6](https://github.com/mikeyhodl/vibesdk/commit/ff604c6fafa42be76431d3dd8038edc9b4a71aa5))
...
* provide git tools to deep_debugger + reset functionality ([0c0a777](https://github.com/mikeyhodl/vibesdk/commit/0c0a7776203fbf728a9ab281206bb5e99f03d35a))
* purely in-isolate template unzip + inmemory storage ([3cd14ed](https://github.com/mikeyhodl/vibesdk/commit/3cd14ed58a4fe786523a4e5c63348c0b2671ee78))
* readme update ([33f72ab](https://github.com/mikeyhodl/vibesdk/commit/33f72ab3dea70c1bc2c13e9ce30f79caa1c99422))
* redact older phase details to optimize context length in prompts ([2cd720e](https://github.com/mikeyhodl/vibesdk/commit/2cd720ea26e6c03dcdeb250b4d93546da1f52d91))
...
* remove code-review system in favor of deep-debugger + user prompt ([bafe0d9](https://github.com/mikeyhodl/vibesdk/commit/bafe0d9fe63312895f8df4cfd6ae035d9199cf11))
...
* replace template manager with ai template selector ([234860f](https://github.com/mikeyhodl/vibesdk/commit/234860fe1ff60b5018a9b08d54ece3adfc631aa4))
* reworked github flow, pure DO based + cache token to avoid oauth ([7f33d02](https://github.com/mikeyhodl/vibesdk/commit/7f33d02d4b9cf3408f546fe4efd46b9038b79297))
...
* sandboxsdk 0.4.3 port + in-memory template details zip extraction ([fd63813](https://github.com/mikeyhodl/vibesdk/commit/fd638136bc7261869fefbef2692ec488adabc5d9))
...
* store full histories in separate DO table ([429b03b](https://github.com/mikeyhodl/vibesdk/commit/429b03b0d9ff1963c0f03d141c7a4f14726a113e))
...
* true convo compactification + archive to r2 ([eb81e9a](https://github.com/mikeyhodl/vibesdk/commit/eb81e9aca3ec52cca319fc3cbe8abb2945658a23))
...
* update to latest packages ([9ce7c55](https://github.com/mikeyhodl/vibesdk/commit/9ce7c5509b2055e88e1f546b82563eb4c8825e59))
* updated llm.md and claude.md ([6ae57ef](https://github.com/mikeyhodl/vibesdk/commit/6ae57ef15963102b9524ebdd26e4eda3feabebd9))
...
* use agentic builder directly for handling user messages ([06d9ce9](https://github.com/mikeyhodl/vibesdk/commit/06d9ce92c6896677cce47a683d7e85aa02238456))
* use custom isomorphic-git fork + fix fs adapter and integration ([27640b8](https://github.com/mikeyhodl/vibesdk/commit/27640b8020a767cd3e2ccbe0282c8cc961284408))
...
* add additional ownership verification checks ([b74a645](https://github.com/mikeyhodl/vibesdk/commit/b74a645202937d0e8538265c9b7c6467f084655e))
* add ESM type declarations for isomorphic-git and update imports ([5bff523](https://github.com/mikeyhodl/vibesdk/commit/5bff5235f941fa198d93b482b74afcce64a4b716))
* add missing await for async getFullState call in getAgentState function ([b0afd15](https://github.com/mikeyhodl/vibesdk/commit/b0afd1533f736976367e8a3585a7d260d76fd8c4))
...
* add optional chaining to prevent runtime errors in blueprint rendering ([bb09d92](https://github.com/mikeyhodl/vibesdk/commit/bb09d9207a715476025accfed8d4fae36143b513))
* add ownership/access checks in git protocol handlers ([ff9643a](https://github.com/mikeyhodl/vibesdk/commit/ff9643afb7d79ac6f58e2b2862b0681e7f94b6f2))
* add setup commands execution after sandbox deployment ([5c471ff](https://github.com/mikeyhodl/vibesdk/commit/5c471ff8ae4d21d678a592e3047b76d5b5153e47))
* Add template migration directly into onStart ([57ee53f](https://github.com/mikeyhodl/vibesdk/commit/57ee53f670178c0e350919d12376e164966a0bf9))
* added instructions for token creation ([3544038](https://github.com/mikeyhodl/vibesdk/commit/354403896f81573316f4ec5ec4fb1cae898fb255))
* added instructions for token creation ([f7cc7ea](https://github.com/mikeyhodl/vibesdk/commit/f7cc7ea2bd243eefa176900e820b30b8a61e4c65))
* added instructions for token creation ([ea3f110](https://github.com/mikeyhodl/vibesdk/commit/ea3f110fd9526da2978dd1064d377bf70f0c7c81))
* allow websockets now in prompts ([406761c](https://github.com/mikeyhodl/vibesdk/commit/406761c89679b2a9998861f3eeef6d2b350a2cb8))
* better deduplication of commands for bootstrap file ([27efc11](https://github.com/mikeyhodl/vibesdk/commit/27efc11290e995187daf0a5f3d5b9b63af779aba))
* better stale comment removal + correct YAML string escaping ([834cffa](https://github.com/mikeyhodl/vibesdk/commit/834cffa6968bc71513640e423a8f504f17d4ef9a))
* build errors ([ddd5639](https://github.com/mikeyhodl/vibesdk/commit/ddd56394887abb248f51948d65895539e6736eba))
* build errors ([3898da4](https://github.com/mikeyhodl/vibesdk/commit/3898da495ec78526b36bf8c6657d5b89d45cefac))
* change phase not found from error to warning ([2b78809](https://github.com/mikeyhodl/vibesdk/commit/2b78809a0751f21a1f9637c91cc4238ebfb2bcf1))
* check repo exists before export ([89ace7f](https://github.com/mikeyhodl/vibesdk/commit/89ace7f6a440de8e7f455d433644da26d260126d))
* clarify Cloudflare WARP note in setup documentation for local development ([49c5dd2](https://github.com/mikeyhodl/vibesdk/commit/49c5dd222efe1e89c1ffbc89684183e106e86b41))
* clarify docs and align ([5e1df23](https://github.com/mikeyhodl/vibesdk/commit/5e1df2364181d98adab392e207a6b74aefe8a669))
* cleanup chat.tsx for build ([d80c416](https://github.com/mikeyhodl/vibesdk/commit/d80c41625684f501e59d600593572c3832251638))
* cleanup chat.tsx for build ([670c8d6](https://github.com/mikeyhodl/vibesdk/commit/670c8d6c241d38335676440ecaa6225795ba6f2a))
* client and logger management in DeploymentManager ([2a19261](https://github.com/mikeyhodl/vibesdk/commit/2a192612e0c9c37efabd8712f6804cb184c80745))
* code debugger prompt improvements ([06375ce](https://github.com/mikeyhodl/vibesdk/commit/06375ce09891d311acc8b283391d2378a50f35f0))
* concurrent deploy + use nanoid + stalestate ([ee61d46](https://github.com/mikeyhodl/vibesdk/commit/ee61d464fbcd712a20ff822bdb76e0cf881e1aa3))
...
* convo id uniqueness and improve message deduplication ([d45f368](https://github.com/mikeyhodl/vibesdk/commit/d45f3688a017496604e6dffe454c083d506fed74))
...
* correct metadata file path and instance ID generation ([4e932f8](https://github.com/mikeyhodl/vibesdk/commit/4e932f889e7e1630dc1f0693af0b3514c63d69e2))
...
* disabled tracing causing deployment failures for non-GA ([1fa292e](https://github.com/mikeyhodl/vibesdk/commit/1fa292ea92642992c867ee0a004fe1ed71a80c79))
...
* don't wait for runtime errors if app not deployed ([0dd3e7e](https://github.com/mikeyhodl/vibesdk/commit/0dd3e7ef357a0193d6f8f5de9771306ab13754bd))
* dont clear runtime errors on executeDeepDebug ([1eda73e](https://github.com/mikeyhodl/vibesdk/commit/1eda73ef5a57aa6203d9b7dac9d39bf160b2af00))
* ensure tool messages are preserved with their matching assistant tool_calls during conversation compactification ([78fe339](https://github.com/mikeyhodl/vibesdk/commit/78fe33936649039cb5adcd98dd01f0987f3c0891))
...
* ensure workspace directory exists before writing files ([bb23e88](https://github.com/mikeyhodl/vibesdk/commit/bb23e88aa4b081a70803dc9cb82fe135acb1c456))
* escape single quotes in GitHub workflow commands ([d7e534a](https://github.com/mikeyhodl/vibesdk/commit/d7e534a20696fd07192852e6755fb49aca6dacf6))
* fileRegeneration was using realtimeCodeFixer's model config ([989aa1b](https://github.com/mikeyhodl/vibesdk/commit/989aa1bf9c649558bd4aa959c906cf438be29ef6))
* files format ([da31e76](https://github.com/mikeyhodl/vibesdk/commit/da31e761e6cba4e839f5f0c527410128f5b18fd7))
* files format ([feca8ca](https://github.com/mikeyhodl/vibesdk/commit/feca8ca7c0ac3e4fb1ca6a5d7d859d96236ad53b))
* filter protected files ([ff3a302](https://github.com/mikeyhodl/vibesdk/commit/ff3a302bf8fa3059156c4f10efc30c55aa6f0455))
* filter websocket failed errors ([6df1d30](https://github.com/mikeyhodl/vibesdk/commit/6df1d30cbfc4fe27a7febc5fb72f40e19b9dfbea))
* finish posting to files map ([b73557e](https://github.com/mikeyhodl/vibesdk/commit/b73557e4ed141191aba31a1fd6dceb7cbb86ec14))
* fix all structured format failing tests ([5d6e74f](https://github.com/mikeyhodl/vibesdk/commit/5d6e74fff7abcaa78e06afbb7e57cf260503a4c0))
...
* Fixed filtering important files ([d3d4776](https://github.com/mikeyhodl/vibesdk/commit/d3d47769a7331523c2e2cb4c07b5408e3b7c862f))
* fixed setup project broken ([6a48871](https://github.com/mikeyhodl/vibesdk/commit/6a4887103e388784def70ee12b15c916ee2b3eb2))
* generation context template details passing ([2b761d0](https://github.com/mikeyhodl/vibesdk/commit/2b761d0d3d45d43206212f1166b98fb8dbcf3732))
* GitHub repository handling for exports to existing repo ([d7c4261](https://github.com/mikeyhodl/vibesdk/commit/d7c4261e527c8b54291d8cc3d703492bf8e19ebc))
* handle missing sandbox instance by returning empty issues object ([1259176](https://github.com/mikeyhodl/vibesdk/commit/1259176c3b77500c4d145207f33d4a29cad20d74))
* handle parent dir creation in sandbox ([262bf69](https://github.com/mikeyhodl/vibesdk/commit/262bf691ace3b66212128f18278e8f9fe348a0ec))
...
* log results object correctly and suppress init error propagation in generator agent ([bb0d97e](https://github.com/mikeyhodl/vibesdk/commit/bb0d97e3236bf048f2bb5aa545a1b50fae86e81e))
...
* only generate AI proxy vars when JWT secret is configured ([701fe81](https://github.com/mikeyhodl/vibesdk/commit/701fe8171b7098f0d470f8a56a9ae50b394f924f))
* Only update dependencies during package.json sync + migrations ([52fdf38](https://github.com/mikeyhodl/vibesdk/commit/52fdf385c4a25ed7e1df8adc1b273ac28c7f7770))
...
* prevent null ruleId in ESLint diagnostic messages by providing empty string fallback ([b76d000](https://github.com/mikeyhodl/vibesdk/commit/b76d000b919ddf4cdeb36891afa6078325f8e59c))
* prevent race condition in code generation state ([188ba0d](https://github.com/mikeyhodl/vibesdk/commit/188ba0d1bdf7f30fd258275804e311921457d5e9))
* prevent reuse of aborted controllers and improve sandbox deployment resilience ([d5092b0](https://github.com/mikeyhodl/vibesdk/commit/d5092b0c1757071efedd9c5a10677691e5497040))
...
* prompt react fixes ([0c3a841](https://github.com/mikeyhodl/vibesdk/commit/0c3a841b72497bd97169de907a806d8527ff0abd))
...
* refresh to csrf token after register/login ([a1225c8](https://github.com/mikeyhodl/vibesdk/commit/a1225c8b86643280a2b6ac4f0fd73753a8b2c08f))
* remove experimental remote bindings from vite config ([4a180b5](https://github.com/mikeyhodl/vibesdk/commit/4a180b50849a63e35316b458f6e114b7944b648f))
* remove hardcoded models ([b98f862](https://github.com/mikeyhodl/vibesdk/commit/b98f86280dd802cb226dd2d7e836e6ee8b713b5e))
...
* rendering and migration for template details change ([af1ba31](https://github.com/mikeyhodl/vibesdk/commit/af1ba3155e458320abc6d67c60ca7e4276885ec4))
...
* simply use git push from isomorphic git to sync with github ([f13fab7](https://github.com/mikeyhodl/vibesdk/commit/f13fab7f97d6f64e6899aeebe22bd51d41d46152))
* simply use images rest api for uploading images ([b97fb68](https://github.com/mikeyhodl/vibesdk/commit/b97fb683f62016658cc9bb332af0c636132fd4d7))
...
* standardize isomorphic-git imports and resolve ESM compatibility issues ([9e1a98b](https://github.com/mikeyhodl/vibesdk/commit/9e1a98bb5dcb170b7ccba2c6430dbfeaeea7405d))
* store history reliably + user images in r2 ([47ae9e4](https://github.com/mikeyhodl/vibesdk/commit/47ae9e48c825ea2d88f55a4c9122d10214ac57f1))
...
* template cache clear before import + init meta in behavior constructor ([5deea6a](https://github.com/mikeyhodl/vibesdk/commit/5deea6ae9ba7c831fb275764b3400e068f3f0f1c))
...
* template import and state init ([060cc9e](https://github.com/mikeyhodl/vibesdk/commit/060cc9e0e5ac5d821f9f1666da229443538a1a38))
* template initialization ([7db6ca2](https://github.com/mikeyhodl/vibesdk/commit/7db6ca2a7d8f9f6e418e38379a5e25f0caaf5c0d))
* template initialization ([e8d07af](https://github.com/mikeyhodl/vibesdk/commit/e8d07affe902bab37aa585ce58d3915b08139893))
* try use github_token instead of odic ([cdc68c5](https://github.com/mikeyhodl/vibesdk/commit/cdc68c569c9595abaa6ead331845058e0672021c))
* tune deep debug config ([6d361eb](https://github.com/mikeyhodl/vibesdk/commit/6d361eb1cd4218a4ec7a2c1ec5d1bcc276d1b64b))
* typeScript features configurable to reduce memory ([d3f984c](https://github.com/mikeyhodl/vibesdk/commit/d3f984c3fd8e5ce4909f5849b97c3ecd3b900dd2))
* ui and convo state management ([0323c7a](https://github.com/mikeyhodl/vibesdk/commit/0323c7a04e20a6abae41ee1ca7483b6360e4698f))
* ui and convo state management ([bbf1979](https://github.com/mikeyhodl/vibesdk/commit/bbf19790004dc570b33dce07399c59276809e1fd))
...
* ui auto focus, preview hiding and blueprints ([868ba34](https://github.com/mikeyhodl/vibesdk/commit/868ba34aae25855791f24dff41bebf6ff6f4cb8f))
* unescape commit messages before git operations ([d51310b](https://github.com/mikeyhodl/vibesdk/commit/d51310b77723c87749a34c20b78a415054298eaa))
* update migration command to include local migrations ([78929ef](https://github.com/mikeyhodl/vibesdk/commit/78929ef12b8a280d7ce8aeda4c51f3175a687b55))
* update setup documentation and script to address Cloudflare WARP issues and add tunnel preview option ([84c3f2d](https://github.com/mikeyhodl/vibesdk/commit/84c3f2d04d6942bbb185463758e7467745f2fb2a))
* updated sandbox dockerfile ([34d5988](https://github.com/mikeyhodl/vibesdk/commit/34d598836b9f33a94eab0650c2dfafdffcf02bfc))
* updated sandbox dockerfile ([0ee9218](https://github.com/mikeyhodl/vibesdk/commit/0ee9218fc567308224158a0d27d71c73cef9c482))
* use correct error field in deployment failure toast message ([dcf98a4](https://github.com/mikeyhodl/vibesdk/commit/dcf98a4240447f79d5612d8f92284902fc144846))
...
* use templateName check instead of isInitialized() for agent start validation ([d9c7a30](https://github.com/mikeyhodl/vibesdk/commit/d9c7a30732b5dcc5baf6c39635332ebe1030f9cd))
...
* wire up onConnect to coding agent ([40ab40e](https://github.com/mikeyhodl/vibesdk/commit/40ab40ec472d68f0f6bc1ffb3460593d5b94aa92))


### Performance Improvements

* optimize binary file detection and base64 encoding in zip extractor ([a6c67d0](https://github.com/mikeyhodl/vibesdk/commit/a6c67d01be38e235207a647b83dd5dde0167dd49))
* optimize file operations and reduce unnecessary commits ([650b967](https://github.com/mikeyhodl/vibesdk/commit/650b967bbbd760a91a29f97a9700801bdecb5539))
* optimize file writing with batched shell script to reduce API requests ([f4f4f7b](https://github.com/mikeyhodl/vibesdk/commit/f4f4f7ba2ac441612f6cbae7a20e3c54da882231))
* optimize git clone by only including reachable objects ([4716f4e](https://github.com/mikeyhodl/vibesdk/commit/4716f4e49e483ae71f4e3e5513ad310c1429d3a8))
* reuse image bytes buffer for both Cloudflare Images and R2 uploads ([bb3de20](https://github.com/mikeyhodl/vibesdk/commit/bb3de207437079569435492d7be02d552b799628))
